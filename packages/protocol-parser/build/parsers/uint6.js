    ...
    write(buffer, cursor, value) {
        switch (cursor.subByteOffset) {
            ...
            case 3:
                ...
                bit_1.default.prototype.write(buffer, cursor, (value >> 5));
                break;
            case 4:
                uint4_1.default.prototype.write(buffer, cursor, value);
                uint2_1.default.prototype.write(buffer, cursor, (value >> 4));
                break;
            case 5:
                uint3_1.default.prototype.write(buffer, cursor, value);
                uint3_1.default.prototype.write(buffer, cursor, value >> 3);
                break;
            case 6:
                uint2_1.default.prototype.write(buffer, cursor, value);
                uint4_1.default.prototype.write(buffer, cursor, value >> 2);
                break;
            case 7:
                bit_1.default.prototype.write(buffer, cursor, (value & 1));
                uint5_1.default.prototype.write(buffer, cursor, value >> 1);
                break;
        }
    }
}
exports.default = Uint6;
//# sourceMappingURL=uint6.js.map