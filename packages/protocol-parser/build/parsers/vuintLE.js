...
class Vuint {
    ...
    write(value) {
        if (value <= 0x7f) {
            ...
            uint16LE_1.default.prototype.write(buffer, new _common_1.Cursor(), value);
            return [buffer];
        }
        else if (value <= 0xffff7f) {
            const buffer = core_1.Buffer.alloc(3);
            uint24LE_1.default.prototype.write(buffer, new _common_1.Cursor(), value);
            return [buffer];
        }
        else if (value <= 0xffffff7f) {
            const buffer = core_1.Buffer.alloc(4);
            uint32LE_1.default.prototype.write(buffer, new _common_1.Cursor(), value);
            return [buffer];
        }
        else
...
//# sourceMappingURL=vuintLE.js.map