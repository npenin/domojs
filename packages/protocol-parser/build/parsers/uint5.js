...
class Uint5 {
    ...
    read(buffer, cursor) {
        ...
        switch (cursor.subByteOffset) {
            case 0:
                value = (currentValue & 0b00011111);
                break;
            case 1:
                value = (currentValue & 0b00111110) >> cursor.subByteOffset;
                break;
            case 2:
                value = (currentValue & 0b01111100) >> cursor.subByteOffset;
                break;
            case 3:
    ...
    write(buffer, cursor, value) {
        switch (cursor.subByteOffset) {
            ...
            case 3:
                var currentValue = buffer.readUInt8(cursor.floorOffset);
                value = (value & 0b11111) << cursor.subByteOffset;
                buffer.writeUInt8(currentValue | value, cursor.floorOffset);
                cursor.offset += length;
                break;
            case 4:
                uint4_1.default.prototype.write(buffer, cursor, value);
                bit_1.default.prototype.write(buffer, cursor, (value >> 4 & 1));
                break;
            case 5:
                uint3_1.default.prototype.write(buffer, cursor, value);
                uint2_1.default.prototype.write(buffer, cursor, value >> 3);
                break;
            case 6:
                uint2_1.default.prototype.write(buffer, cursor, value);
                uint3_1.default.prototype.write(buffer, cursor, value >> 2);
                break;
            case 7:
                bit_1.default.prototype.write(buffer, cursor, (value & 1));
                uint4_1.default.prototype.write(buffer, cursor, value >> 1);
                break;
        }
    }
}
exports.default = Uint5;
//# sourceMappingURL=uint5.js.map