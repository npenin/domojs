...
import { IBuffer, uint8 } from "../core";

const length = .625;

export default class Uint5 implements Parser<uint8>
{
    constructor()
    {
    ...
    public write(buffer: IBuffer, cursor: Cursor, value: number)
    {
        switch (cursor.subByteOffset)
        {
            ...
            case 4:
                ...
                Bit.prototype.write(buffer, cursor, (value >> 4 & 1));
                break;
            case 5:
                Uint3.prototype.write(buffer, cursor, value);
                Uint2.prototype.write(buffer, cursor, value >> 3);
                break;
            case 6:
                Uint2.prototype.write(buffer, cursor, value);
                Uint3.prototype.write(buffer, cursor, value >> 2);
                break;
            case 7:
                Bit.prototype.write(buffer, cursor, (value & 1));
                Uint4.prototype.write(buffer, cursor, value >> 1);
                break;
        }
    }
}