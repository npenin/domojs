...
export default class Uint7 implements Parser<uint8>
{
    constructor()
    {
    ...
    public write(buffer: IBuffer, cursor: Cursor, value: uint8)
    {
        switch (cursor.subByteOffset)
        {
            case 0:
            ...
            case 2:
                ...
                Bit.prototype.write(buffer, cursor, (value >> 6));
                break;
            case 3:
                Uint5.prototype.write(buffer, cursor, value);
                Uint2.prototype.write(buffer, cursor, (value >> 5));
                break;
            case 4:
                Uint4.prototype.write(buffer, cursor, value);
                Uint3.prototype.write(buffer, cursor, (value >> 4));
                break;
            case 5:
                Uint3.prototype.write(buffer, cursor, value);
                Uint4.prototype.write(buffer, cursor, value >> 3);
                break;
            case 6:
                Uint2.prototype.write(buffer, cursor, value);
                Uint5.prototype.write(buffer, cursor, value >> 2);
                break;
            case 7:
                Bit.prototype.write(buffer, cursor, (value & 1));
                Uint6.prototype.write(buffer, cursor, value >> 1);
                break;
        }
    }
}