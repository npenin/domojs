...
export default class Switch<T extends { [key in TKey]: TValue }, TKey extends Exclude<keyof T, number | Symbol>, TResult, TValue extends string | number> implements ParserWithMessageWithoutKnownLength<TResult, T>
{
    ...
    length: -1 = -1;
    read(buffer: IBuffer, cursor: Cursor, message: T): TResult
    {
    ...
    write(value: TResult, message: T): IBuffer[]
    {
