...
export class Sub<TResult, TMessage> implements ParserWithMessageWithoutKnownLength<TResult | null, TMessage>
{
    ...
    read(buffer: IBuffer, cursor: Cursor, message: TMessage): TResult | null
    {
    ...
    write(value: TResult, message: TMessage): IBuffer[];
    write(buffer: IBuffer, cursor: Cursor, value: TResult, message: TMessage): void;
    write(buffer: IBuffer | TResult, cursor?: Cursor | TMessage, value?: TResult, message?: TMessage)
    {
