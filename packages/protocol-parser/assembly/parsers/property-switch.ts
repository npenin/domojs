...
export default class SwitchProperty<T, TKey extends Exclude<keyof T, Symbol>, TKeyAssign extends keyof T, TResult, TValue extends (T[TKey] extends string | number | symbol ? T[TKey] : never)>
