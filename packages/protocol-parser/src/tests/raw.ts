...
import { Buffer, uint64 as u64 } from '../../build/core'
import { array, bit, string, uint16, uint16LE, uint2, uint3, uint32, uint32LE, uint4, uint5, uint6, uint64, uint7, uint8 } from '../../build/parsers'
import { Cursor, Parser, parserWrite } from '../../build/parsers/_common'
...
function readArrayType(name: string, type: Parser<number>, length: number)
{
    ...
    describe(name + '[]', function ()
    {
        ...
        it('should read and write from buffer', function ()
        {
            ...
            var buffer = Buffer.alloc(length * type.length + 1);
...
describe('read', function ()
{
    ...
    describe('string', function ()
    {
        ...
        {
            var expected = 'string'
            var buffer = Buffer.alloc(expected.length + 1);
