...
export type MandatoryKeys = import ("./BaseDeviceType.js").MandatoryKeys | ReverseClusterIdNames[0x0003] | ReverseClusterIdNames[0x0004] | ReverseClusterIdNames[0x0102] | ReverseClusterIdNames[0x0104] | ReverseClusterIdNames[0x0105]
