...
export type MandatoryKeys = import ("./BaseDeviceType.js").MandatoryKeys | ReverseClusterIdNames[0x0003] | ReverseClusterIdNames[0x0004] | ReverseClusterIdNames[0x0006] | ReverseClusterIdNames[0x0008] | ReverseClusterIdNames[0x0062] | ReverseClusterIdNames[0x0300]
