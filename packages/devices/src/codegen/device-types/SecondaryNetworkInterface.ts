...
export type MandatoryKeys = import ("./BaseDeviceType.js").MandatoryKeys | ReverseClusterIdNames[0x0031] | ReverseClusterIdNames[0x0035] | ReverseClusterIdNames[0x0036] | ReverseClusterIdNames[0x0037]
