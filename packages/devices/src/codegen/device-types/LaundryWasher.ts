...
export type MandatoryKeys = import ("./BaseDeviceType.js").MandatoryKeys | ReverseClusterIdNames[0x0003] | ReverseClusterIdNames[0x0006] | ReverseClusterIdNames[0x0051] | ReverseClusterIdNames[0x0053] | ReverseClusterIdNames[0x0056] | ReverseClusterIdNames[0x0060]
