...
export type MandatoryKeys = import ("./BaseDeviceType.js").MandatoryKeys | ReverseClusterIdNames[0x0003] | ReverseClusterIdNames[0x0006] | ReverseClusterIdNames[0x0056] | ReverseClusterIdNames[0x0059] | ReverseClusterIdNames[0x005D] | ReverseClusterIdNames[0x0060]
