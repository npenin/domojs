...
export type MandatoryKeys = import ("./BaseDeviceType.js").MandatoryKeys | ReverseClusterIdNames[0x0035] | ReverseClusterIdNames[0x0451] | ReverseClusterIdNames[0x0452] | ReverseClusterIdNames[0x0453]
