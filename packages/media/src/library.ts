...
namespace library
{
	export interface container 
	{
		...
		dispatch(cmd: 'dropbox', ...args: [Argument0<typeof import('./server/commands/library/dropbox.js').default>, Argument1<typeof import('./server/commands/library/dropbox.js').default>, Argument2<typeof import('./server/commands/library/dropbox.js').default>, Argument3<typeof import('./server/commands/library/dropbox.js').default>, Argument4<typeof import('./server/commands/library/dropbox.js').default>, Argument5<typeof import('./server/commands/library/dropbox.js').default>, Argument6<typeof import('./server/commands/library/dropbox.js').default>, Argument7<typeof import('./server/commands/library/dropbox.js').default>]): ReturnType<typeof import('./server/commands/library/dropbox.js').default>
	...
	export interface proxy 
	{
		...
		'dropbox'(...args: [Argument0<typeof import('./server/commands/library/dropbox.js').default>, Argument1<typeof import('./server/commands/library/dropbox.js').default>, Argument2<typeof import('./server/commands/library/dropbox.js').default>, Argument3<typeof import('./server/commands/library/dropbox.js').default>, Argument4<typeof import('./server/commands/library/dropbox.js').default>, Argument5<typeof import('./server/commands/library/dropbox.js').default>, Argument6<typeof import('./server/commands/library/dropbox.js').default>, Argument7<typeof import('./server/commands/library/dropbox.js').default>]): ReturnType<typeof import('./server/commands/library/dropbox.js').default>
