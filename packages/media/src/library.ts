...
namespace library
{
	export interface container 
	{
		...
		dispatch (cmd:'add-scrapper', ...args: [Argument0<typeof import('./server/commands/library/add-scrapper').default>, Argument1<typeof import('./server/commands/library/add-scrapper').default>]): ReturnType<typeof import('./server/commands/library/add-scrapper').default>
		...
		dispatch (cmd:'list-folders', ...args: [Argument0<typeof import('./server/commands/library/list-folders').default>]): ReturnType<typeof import('./server/commands/library/list-folders').default>
		dispatch (cmd:'list-libraries', ...args: []): ReturnType<typeof import('./server/commands/library/list-libraries').default>
		dispatch (cmd:'list-scrappers', ...args: []): ReturnType<typeof import('./server/commands/library/list-scrappers').default>
	...
	export interface proxy 
	{
		...
		'add-scrapper'(...args: [Argument0<typeof import('./server/commands/library/add-scrapper').default>, Argument1<typeof import('./server/commands/library/add-scrapper').default>]): ReturnType<typeof import('./server/commands/library/add-scrapper').default>
		...
		'list-folders'(...args: [Argument0<typeof import('./server/commands/library/list-folders').default>]): ReturnType<typeof import('./server/commands/library/list-folders').default>
		'list-libraries'(...args: []): ReturnType<typeof import('./server/commands/library/list-libraries').default>
		'list-scrappers'(...args: []): ReturnType<typeof import('./server/commands/library/list-scrappers').default>
